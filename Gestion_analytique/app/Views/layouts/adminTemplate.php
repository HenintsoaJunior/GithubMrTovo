                ...
                <section class="sidebar" style="height: auto;">
                    <ul class="sidebar-menu" id="menuslider">
                        ...
                        <?php $session = session();?>
                            ...
                            <?php if ($session->get('status') === 'admin'): // Vérifiez si le statut est admin ?>
                                <div class="dropdown">
                                    <li>
                                        <a style="display: block; padding: 8px;" href="#" class="" onclick="window.location.href='#'">
                                            <i style="margin-right: 3.6px;" class="fa fa-envelope"></i>
                                            <span>Message</span>
                                            <i class="fa fa-angle-left pull-right"></i>
                                        </a>
                                        <ul class="treeview-menu">
                                            <li><a href="<?= base_url('pro_format_charge-list') ?>" class=""><i class="fa fa-table"></i>Validation Pro Format Charge</a></li>
                                            <li><a href="<?= base_url('pro_format_produit-list') ?>" class=""><i class="fa fa-table"></i>Validation Pro Format Produit</a></li>
                                        </ul>
                                    </li>
                                </div>
                                ...
                                <div class="dropdown">
                                    <li>
                                        <a style="display: block; padding: 8px;" href="#" class="" onclick="window.location.href='#'">
                                            <i style="margin-right: 3.6px;" class="fa fa-info-circle"></i>
                                            <span>Information</span>
                                            <i class="fa fa-angle-left pull-right"></i>
                                        </a>
                                        <ul class="treeview-menu">
                                            <li><a href="<?= base_url('bon_sortie-list') ?>" class=""><i class="fa fa-table"></i>Bon de Sortie</a></li>
                                            <li><a href="<?= base_url('bon_livraison-list') ?>" class=""><i class="fa fa-table"></i>Bon de Livraison</a></li>
                                        </ul>
                                    </li>
                                </div>
                                ...
                                <div class="dropdown">
                                    <li>
                                        <a style="display: block; padding: 8px;" href="#" class="" onclick="window.location.href='#'">
                                            <i style="margin-right: 3.6px;" class="fa fa-archive"></i>
                                            <span>Stock</span>
                                            <i class="fa fa-angle-left pull-right"></i>
                                        </a>
                                        <ul class="treeview-menu">
                                            <li><a href="<?= base_url('stock-form') ?>" class=""><i class="fa fa-plus"></i>Form</a></li>
                                            <li><a href="<?= base_url('stock-list') ?>" class=""><i class="fa fa-table"></i>Liste</a></li>
                                        </ul>
                                    </li>
                                </div>
                                ...
                                <div class="dropdown">
                                    <li>
                                        <a style="display: block; padding: 8px;" href="#" class="" onclick="window.location.href='#'">
                                            <i style="margin-right: 3.6px;" class="fa fa-calculator"></i>
                                            <span>Compta</span>
                                            <i class="fa fa-angle-left pull-right"></i>
                                        </a>
                                        <ul class="treeview-menu">
                                            <li><a href="<?= base_url('compta_sous_ecriture') ?>" class=""><i class="fa fa-table"></i>compta sous ecriture</a></li>
                                ...
                                <?php else: ?>
                                    <div class="dropdown">
                                        <li>
                                            <a style="display: block; padding: 8px;" href="#" class="" onclick="window.location.href='#'">
                                                <i style="margin-right: 3.6px;" class="fa fa-shopping-cart"></i>
                                                <span>Vente</span>
                                                <i class="fa fa-angle-left pull-right"></i>
                                            </a>
                                            <ul class="treeview-menu">
                                                <li>
                                                    <a href="<?= base_url('liste_vente_admin') ?>" class="">
                                                        <i class="fa fa-table"></i> Validation Vente
                                                    </a>
                                                </li>
                                            </ul>
                                        </li>
                                    ...
                                    <div class="dropdown">
                                        <li>
                                            ...
                                            <ul class="treeview-menu">
                                                <li><a href="<?= base_url('achatform') ?>" class=""><i class="fa fa-plus"></i>Achat</a></li>
                                                <li><a href="<?= base_url('pro_format_charge_user') ?>" class=""><i class="fa fa-table"></i>Pro Format Charge</a></li> <!-- Changed icon to fa-info-circle for Details -->
                                                <li><a href="<?= base_url('pro_format_produit_user') ?>" class=""><i class="fa fa-table"></i>Pro Format Produit</a></li> <!-- Changed icon to fa-info-circle for Details -->
                                    ...
                                    <div class="dropdown">
                                        <li>
                                            <a style="display: block; padding: 8px;" href="#" class="" onclick="window.location.href='#'">
                                            <i style="margin-right: 3.6px;" class="fa fa-tags"></i>
                                            <!-- Updated icon to represent Vente -->
                                            <span>Produit</span>

                                                <i class="fa fa-angle-left pull-right"></i>
                                            </a>
                                            <ul class="treeview-menu">
                                                <li><a href="<?= base_url('produit-form')?>" class=""><i class="fa fa-plus"></i>Formulaire</a></li>
                                                <li><a href="<?= site_url('/produit-list') ?>" class=""><i class="fa fa-info-circle"></i>Liste Produit</a></li> <!-- Changed icon to fa-info-circle for Details -->
                                            </ul>
                                        </li>
                                    </div>
