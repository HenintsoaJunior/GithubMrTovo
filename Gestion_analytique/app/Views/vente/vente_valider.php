...
<body>
    <div class="body">
        <div class="all-container col-12">
            ...
            <!-- header text -->
            <span class="text-white fs-4 fw-lighter login-text">Vente Valider</span>
            
            <div class="signin-container rounded">
                <img src="<?= base_url('assets/img/rdv_success.png') ?>" alt="rdv logo" class="rdv">
                <form action="<?= site_url('/facture_pdf') ?>" method="get">
                    <input type="hidden" name="id_br" value="<?= $id_br ?>">
                    <input type="submit" value="Facture" class="btn btn-success signin-btn">
                </form>

                <form action="<?= base_url('/liste_vente_admin') ?>" method="get" class="form-retour">
