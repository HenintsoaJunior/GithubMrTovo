                        ...
                        <div class="dropdown">
                            <li>
                                <a style="display: block; padding: 8px;" href="#" class="" onclick="window.location.href='#'">
                                    <i style="margin-right: 3.6px;" class="fa fa-envelope"></i> <!-- Changed icon to fa-bar-chart for Prevision -->
                                    <span>Vente</span>
                                    <i class="fa fa-angle-left pull-right"></i>
                                </a>
                                <ul class="treeview-menu">
                                   <li><a href="<?= base_url('liste_vente_admin') ?>" class=""><i class="fa fa-table"></i>Liste Vente</a></li> <!-- Changed icon to fa-info-circle for Details -->
